...
extern "C" {
    ...
    pub fn astal_tray_tray_get_item(self_: *mut AstalTrayTray, item_id: *const c_char) -> *mut AstalTrayTrayItem;
    ...
    pub fn astal_tray_tray_item_get_menu_model(self_: *mut AstalTrayTrayItem) -> *mut gio::GMenuModel;
    pub fn astal_tray_tray_item_get_action_group(self_: *mut AstalTrayTrayItem) -> *mut gio::GActionGroup;
