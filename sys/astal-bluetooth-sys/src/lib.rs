...
extern "C" {
    ...
    pub fn astal_bluetooth_adapter_remove_device(self_: *mut AstalBluetoothAdapter, device: *mut AstalBluetoothDevice);
    pub fn astal_bluetooth_adapter_start_discovery(self_: *mut AstalBluetoothAdapter);
    pub fn astal_bluetooth_adapter_stop_discovery(self_: *mut AstalBluetoothAdapter);
    pub fn astal_bluetooth_adapter_get_object_path(self_: *mut AstalBluetoothAdapter) -> *mut c_char;
    pub fn astal_bluetooth_adapter_set_object_path(self_: *mut AstalBluetoothAdapter, value: *const c_char);
    ...
    pub fn astal_bluetooth_device_cancel_pairing(self_: *mut AstalBluetoothDevice);
    ...
    pub fn astal_bluetooth_device_connect_device_finish(self_: *mut AstalBluetoothDevice, _res_: *mut gio::GAsyncResult);
    ...
    pub fn astal_bluetooth_device_disconnect_device_finish(self_: *mut AstalBluetoothDevice, _res_: *mut gio::GAsyncResult);
    pub fn astal_bluetooth_device_connect_profile(self_: *mut AstalBluetoothDevice, uuid: *const c_char);
    pub fn astal_bluetooth_device_disconnect_profile(self_: *mut AstalBluetoothDevice, uuid: *const c_char);
    pub fn astal_bluetooth_device_pair(self_: *mut AstalBluetoothDevice);
    pub fn astal_bluetooth_device_get_object_path(self_: *mut AstalBluetoothDevice) -> *mut c_char;
    pub fn astal_bluetooth_device_set_object_path(self_: *mut AstalBluetoothDevice, value: *const c_char);
