...
extern "C" {
    ...
    pub fn astal_io_application_request(self_: *mut AstalIOApplication, msg: *const c_char, conn: *mut gio::GSocketConnection, error: *mut *mut glib::GError);
    ...
    pub fn astal_io_send_message(instance: *const c_char, msg: *const c_char, error: *mut *mut glib::GError) -> *mut c_char;
