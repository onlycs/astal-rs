...
// Enums
pub type AstalHyprlandFullscreen = c_int;
pub const ASTAL_HYPRLAND_FULLSCREEN_CURRENT: AstalHyprlandFullscreen = -1;
pub const ASTAL_HYPRLAND_FULLSCREEN_NONE: AstalHyprlandFullscreen = 0;
pub const ASTAL_HYPRLAND_FULLSCREEN_FULLSCREEN: AstalHyprlandFullscreen = 1;
pub const ASTAL_HYPRLAND_FULLSCREEN_MAXIMIZED: AstalHyprlandFullscreen = 2;
