...
extern "C" {
    ...
    pub fn astal_apps_apps_get_include_name(self_: *mut AstalAppsApps) -> gboolean;
    pub fn astal_apps_apps_set_include_name(self_: *mut AstalAppsApps, value: gboolean);
    pub fn astal_apps_apps_get_include_entry(self_: *mut AstalAppsApps) -> gboolean;
    pub fn astal_apps_apps_set_include_entry(self_: *mut AstalAppsApps, value: gboolean);
    pub fn astal_apps_apps_get_include_executable(self_: *mut AstalAppsApps) -> gboolean;
    pub fn astal_apps_apps_set_include_executable(self_: *mut AstalAppsApps, value: gboolean);
    pub fn astal_apps_apps_get_include_description(self_: *mut AstalAppsApps) -> gboolean;
    pub fn astal_apps_apps_set_include_description(self_: *mut AstalAppsApps, value: gboolean);
