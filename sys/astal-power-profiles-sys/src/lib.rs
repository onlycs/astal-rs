...
extern "C" {
    ...
    pub fn astal_power_profiles_power_profiles_to_json_string(self_: *mut AstalPowerProfilesPowerProfiles) -> *mut c_char;
    ...
    pub fn astal_power_profiles_power_profiles_get_performance_inhibited(self_: *mut AstalPowerProfilesPowerProfiles) -> *mut c_char;
