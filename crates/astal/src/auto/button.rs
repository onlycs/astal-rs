...
impl Button {
    ...
    pub fn new() -> Button {
        ...
        unsafe { from_glib_none(ffi::astal_button_new()) }
    }
}
...
pub trait ButtonExt: IsA<Button> + 'static {
    ...
    fn connect_hover<F: Fn(&Self, &HoverEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn hover_trampoline<P: IsA<Button>, F: Fn(&P, &HoverEvent) + 'static>(
            this: *mut ffi::AstalButton,
            event: *mut ffi::AstalHoverEvent,
            f: glib::ffi::gpointer,
        ) {
        ...
        unsafe {
            ...
            connect_raw(
                ...
                b"hover\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    hover_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_hover_lost<F: Fn(&Self, &HoverEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn hover_lost_trampoline<
            P: IsA<Button>,
            F: Fn(&P, &HoverEvent) + 'static,
        >(
            this: *mut ffi::AstalButton,
            event: *mut ffi::AstalHoverEvent,
            f: glib::ffi::gpointer,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"hover-lost\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    hover_lost_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_click<F: Fn(&Self, &ClickEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn click_trampoline<P: IsA<Button>, F: Fn(&P, &ClickEvent) + 'static>(
            this: *mut ffi::AstalButton,
            event: *mut ffi::AstalClickEvent,
            f: glib::ffi::gpointer,
        ) {
            let f: &F = &*(f as *const F);
            f(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    click_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_click_release<F: Fn(&Self, &ClickEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn click_release_trampoline<
            P: IsA<Button>,
            F: Fn(&P, &ClickEvent) + 'static,
        >(
            this: *mut ffi::AstalButton,
            event: *mut ffi::AstalClickEvent,
            f: glib::ffi::gpointer,
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"click-release\0".as_ptr() as *const _,
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    click_release_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
    ...
    fn connect_scroll<F: Fn(&Self, &ScrollEvent) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn scroll_trampoline<
            P: IsA<Button>,
            F: Fn(&P, &ScrollEvent) + 'static,
        >(
            this: *mut ffi::AstalButton,
            event: *mut ffi::AstalScrollEvent,
            f: glib::ffi::gpointer,
        ) {
            let f: &F = &*(f as *const F);
            f(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
                    scroll_trampoline::<Self, F> as *const (),
                )),
                Box_::into_raw(f),
            )
        }
